...
- Fix: Ensure `console.error` in AppErrorBoundary is conditionally called only in development environment (`import.meta.env.DEV`) to prevent leaking stack traces in production.
