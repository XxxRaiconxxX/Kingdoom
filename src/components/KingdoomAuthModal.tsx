  ...
  return createPortal(
    <AnimatePresence>
      <motion.div className="fixed inset-0 z-[999] flex items-start justify-center overflow-y-auto bg-black/75 p-4 backdrop-blur-sm sm:items-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
        <motion.section role="dialog" aria-modal="true" aria-labelledby="kingdoom-auth-title" className="relative my-4 w-full max-w-lg rounded-[2rem] border border-amber-400/25 bg-stone-950 px-5 pb-6 pt-8 text-stone-100 shadow-2xl shadow-black/60 sm:my-8 sm:px-8 sm:pb-8" initial={{ opacity: 0, y: 24, scale: .97 }} animate={{ opacity: 1, y: 0, scale: 1 }}>
