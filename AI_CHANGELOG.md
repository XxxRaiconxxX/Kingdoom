...
- 🧪 **Testing Improvement**: Se configuró Vitest y React Testing Library para el proyecto.
- 🧪 **Testing Improvement**: Se añadieron pruebas unitarias para el componente `HomeSection` aislando la carga de eventos y los enlaces de descarga de la comunidad a través de dependencias mockeadas.
