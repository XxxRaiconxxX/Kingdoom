...
## 2026-06-13 Performance Optimization
- Optimized lookup performance in `getSeriesDetail` from `O(n^2)` array finding to `O(1)` Map lookup.
- Modified `src/features/animeHub/animeHub.mockProvider.ts`.
