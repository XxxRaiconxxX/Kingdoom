    ...
    downloads: [
      {
        ...
        status: "provider-required",
        note: "Aqui faltaria conectar /api/v1/anime/download para generar el enlace real.",
      },
      {
        qualityLabel: "1080p HLS",
        providerLabel: "AnimeFLV",
        status: "provider-required",
        note: "Aqui faltaria resolver /api/v1/anime/episode y el manifest HLS del proveedor.",
      },
    ],
  },
  {
    ...
    downloads: [
      ...
      },
      {
        ...
        status: "provider-required",
        note: "Aqui faltaria conectar /api/v1/anime/batch para colas por temporada.",
      },
    ],
  },
  {
