...
- **Refactor**: Eliminado bloque de comentarios SQL obsoletos en `src/utils/adminRanking.ts` para mejorar la mantenibilidad y legibilidad del código (Código más limpio y fácil de leer sin alterar funcionalidad).
