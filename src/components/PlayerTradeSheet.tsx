                           ...
                           <div className="space-y-2">
                             ...
                             <div className="grid grid-cols-2 md:grid-cols-3 gap-2 overflow-y-auto max-h-48 custom-scrollbar pr-1">
                               {items.map(item => (
                                 ...
                                 >
                                   {item.itemImageUrl ? (
                                     <img loading="lazy" decoding="async"  src={item.itemImageUrl} className="h-10 w-10 object-contain drop-shadow-lg" alt={item.itemName} />
                                   ) : (
                             ...
                             <div className="flex items-center justify-between rounded-xl border border-stone-700 bg-stone-950 p-3">
                               <div className="flex items-center gap-3">
                                  {selectedItem.itemImageUrl ? (
                                     <img loading="lazy" decoding="async"  src={selectedItem.itemImageUrl} className="h-12 w-12 object-contain drop-shadow-md" alt={selectedItem.itemName} />
                                  ) : (
