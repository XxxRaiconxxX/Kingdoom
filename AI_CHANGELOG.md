...
*   **Notas/Advertencias:** El bot está activo y online. Solo requiere escanear el QR generado en su dominio público de Railway. El cambio de la remoción del !daily, la reestructuración de permisos/registro y el nuevo sistema de bienvenida en dos partes fue committeado y pusheado de inmediato para gatillar el despliegue automático en Railway.
